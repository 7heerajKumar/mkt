...
export const aboutText =
  "Hi, I’m Prof. Manoj Kumar Tiwari, Director of IIM Mumbai. I blend the rigour of academic research with the pragmatism of industry to solve complex operations and supply-chain challenges. I work with optimization, simulation, data analytics, and AI to design efficient and resilient systems across manufacturing, logistics, and services, while championing Industry 4.0 and digital transformation. My role lets me ensure that ideas move from classrooms and labs to the shop floor—mentoring students, guiding researchers, and partnering with organizations—so solutions not only work at scale but also create lasting value for business and society."
// End of About Me
...
export const reviewsData = [
  {
    image: '/reviews/IndependanceDaySpeech@2025.png',
    name: 'Independance Day Speech 2025',
    comment:
      "Giving Speech",
  },
  {
